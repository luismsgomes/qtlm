...
# 2015-06-29, luis.gomes@di.fc.ul.pt
# This attribute is used for frustratingly simple domain adaptation
has in_domain => ( is => 'rw', isa => 'Bool', default => undef, documentation => 'is this document in-domain? (false means out of domain)' );
